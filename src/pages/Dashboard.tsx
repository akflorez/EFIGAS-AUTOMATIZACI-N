...
export default function Dashboard({ onLogout }: DashboardProps) {
  ...
  const processData = async () => {
    ...
    setProcessing(true);
    setProgress(5);
    setStatusMessage('Iniciando Motor v46.9.4 (Efigas)...');
  ...
  const exportCSV = () => {
    ...
    link.setAttribute("download", `visitas_v46.9.4.csv`);
    ...
    <div className="flex min-h-screen bg-slate-50 font-sans">
      ...
      <main className="flex-1 ml-72 p-10 animate-premium">
        <header className="flex justify-between items-center mb-10">
          <div>
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Generador de Visitas v46.9.4</h2>
